...
Используйте на свой страх и риск. Удаление подписчиков — необратимый процесс.

FloodWaitError: Если вы удаляете много пользователей, Telegram может временно ограничить ваши действия. Скрипт обработает эту ошибку, подождет необходимое время и продолжит работу.

Ограничения API: Помните, что save и info могут показать только последних ~200 участников из-за ограничений Telegram. Однако функция kickbydate разработана для обхода этого ограничения при чистке.
